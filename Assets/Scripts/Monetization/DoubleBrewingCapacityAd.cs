...
public class DoubleBrewingCapacityAd : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    public void showConfirmationPanel()
    {
        ...
        titleTxt.text = "Watch an AD for 5 minutes of double Brewing Capacity!";
    ...
    public void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
            ...
            Debug.Log("You have gained 5 minutes of double Brewing Capacity!");
            gameManager.StartDoubleBrewingCapacity();
