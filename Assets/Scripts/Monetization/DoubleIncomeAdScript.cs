...
public class DoubleIncomeAdScript : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    {
        titleTxt.text = "Watch an AD for 30 minutes of double income";
    ...
    public void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
            ...
            Debug.Log("You have gained 30 minutes of double income!");
            gameManager.startDoubleIncome();
